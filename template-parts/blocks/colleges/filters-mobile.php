<form id="filter-form-mobile" method="GET" action="">
    ...
    <div class="filter-group">
        ...
        <div class="accordion-content">
            ...
            <div class="checkbox">
                <label for="mobile_state_<?php echo esc_attr($state->slug); ?>">
                    <input type="checkbox" name="state[]" class="filter-input"
                        id="mobile_state_<?php echo esc_attr($state->slug); ?>"
                        value="<?php echo esc_attr($state->slug); ?>">
    ...
    <div class="filter-group">
        ...
        <div class="accordion-content">
            ...
            <div class="checkbox">
                <label for="mobile_type_1_<?php echo esc_attr($value); ?>">
                    <input type="checkbox" name="type_1[]" class="filter-input"
                        id="mobile_type_1_<?php echo esc_attr($value); ?>" value="<?php echo esc_attr($value); ?>">
            ...
            <div class="checkbox">
                <label for="mobile-presence_<?php echo esc_attr($value); ?>">
                    <input type="checkbox" name="presence[]" class="filter-input"
                        id="mobile-presence_<?php echo esc_attr($value); ?>" value="<?php echo esc_attr($value); ?>">
                    <?php echo esc_html($label); ?>
                </label>
            </div>
            <?php endforeach; ?>
    ...
    <button id="clear-filters-mobile" class="button">Clear all filters</button>
</form>