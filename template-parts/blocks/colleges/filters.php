                    ...
                    <?php foreach ($states as $state): ?>
                        <div class="checkbox">
                            <label for="state_<?php echo esc_attr($state->slug); ?>">
                                <input type="checkbox" name="state[]" id="state_<?php echo esc_attr($state->slug); ?>" value="<?php echo esc_attr($state->slug); ?>">
                ...
                <?php foreach ($type_1_choices as $value => $label): ?>
                    <div class="checkbox">
                        <label for="type_1_<?php echo esc_attr($value); ?>">
                            <input type="checkbox" name="type_1[]" id="type_1_<?php echo esc_attr($value); ?>" value="<?php echo esc_attr($value); ?>">
                ...
                <?php foreach ($type_2_choices as $value => $label): ?>
                    <div class="checkbox">
                        <label for="type_2_<?php echo esc_attr($value); ?>">
                            <input type="checkbox" name="type_2[]" id="type_2_<?php echo esc_attr($value); ?>" value="<?php echo esc_attr($value); ?>">
                            <?php echo esc_html($label); ?>
                        </label>
                    </div>
                <?php endforeach; ?>
            ...
            <div class="accordion-content">
                <div class="checkbox">
                    <label for="religious_yes">
                        <input type="checkbox" name="religious" id="religious_yes" value="1">
                        Yes
                    </label>
                </div>
                <div class="checkbox">
                    <label for="religious_no">
                        <input type="checkbox" name="religious" id="religious_no" value="1">
                        No
                    </label>
                </div>
            </div>
            ...
            <div class="accordion-content">
                <div class="checkbox">
                    <label for="accredited_yes">
                        <input type="checkbox" name="accredited[]" id="accredited_yes" value="1">
                        Yes
                    </label>
                </div>
                <div class="checkbox">
                    <label for="accredited_no">
                        <input type="checkbox" name="accredited[]" id="accredited_no" value="0">
                        No
                    </label>
                </div>
            </div>
                ...
                <?php foreach ($presence_choices as $value => $label): ?>
                    <div class="checkbox">
                        <label for="presence_<?php echo esc_attr($value); ?>">
                            <input type="checkbox" name="presence[]" id="presence_<?php echo esc_attr($value); ?>" value="<?php echo esc_attr($value); ?>">
                            <?php echo esc_html($label); ?>
                        </label>
                    </div>
                <?php endforeach; ?>
