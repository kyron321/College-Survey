...
{
    $state_filter = isset($_POST['state']) ? $_POST['state'] : [];
    $type_1_filter = isset($_POST['type_1']) ? $_POST['type_1'] : [];
    $type_2_filter = isset($_POST['type_2']) ? $_POST['type_2'] : [];
    ...
    $presence_filter = isset($_POST['presence']) ? $_POST['presence'] : [];
    ...
    if ($query->have_posts()):
        while ($query->have_posts()):
            ...
            include get_stylesheet_directory() .
                '/template-parts/blocks/colleges/college-list-item.php';
        endwhile;
        wp_reset_postdata();
    else:
         ?>
