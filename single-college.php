...
<main id="main" class="site-main styled-layout" role="main">
    ...
    <section>
        <div class="social-sharing">
            ...
            <a href="https://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>"
                target="_blank" class="social-icon"><i class="fab fa-pinterest"></i></a>
            ...
            <a href="https://www.reddit.com/submit?url=<?php echo urlencode(get_permalink()); ?>" target="_blank"
                class="social-icon"><i class="fab fa-reddit-alien"></i></a>
            <a href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?php echo urlencode(get_permalink()); ?>"
                target="_blank" class="social-icon"><i class="fab fa-tumblr"></i></a>
            <a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site <?php echo urlencode(get_permalink()); ?>"
                target="_blank" class="social-icon"><i class="fas fa-envelope"></i></a>
        </div>
    </section>
    <div class="content-grid">
        ...
        <div class="column column-one">
            ...
            <p> <?php echo (get_the_title()); ?> is a <?php echo strtolower(get_field('type_1')); ?>
                ...
                <?php
                    $website_url = get_field('college_link');
                    if ($website_url): ?>
            ...
            <p><strong>Trans Activism:</strong></p>
